...
#include "altair_interfaces/msg/detail/can_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // active_port, error_message
#include "rosidl_runtime_c/string_functions.h"  // active_port, error_message

// forward declare type support functions


using _CanStatus__ros_msg_type = altair_interfaces__msg__CanStatus;
...
size_t get_serialized_size_altair_interfaces__msg__CanStatus(
  const void * untyped_ros_message,
...
static uint32_t _CanStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_altair_interfaces__msg__CanStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_altair_interfaces
size_t max_serialized_size_altair_interfaces__msg__CanStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = altair_interfaces__msg__CanStatus;
    is_plain =
      (
...
static size_t _CanStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_altair_interfaces__msg__CanStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, msg, CanStatus)() {
