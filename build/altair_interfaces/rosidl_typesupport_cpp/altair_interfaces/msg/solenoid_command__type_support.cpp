...
static const _SolenoidCommand_type_support_symbol_names_t _SolenoidCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, altair_interfaces, msg, SolenoidCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, altair_interfaces, msg, SolenoidCommand)),
  }
};
...
{
  return &::altair_interfaces::msg::rosidl_typesupport_cpp::SolenoidCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, altair_interfaces, msg, SolenoidCommand)() {
  return get_message_type_support_handle<altair_interfaces::msg::SolenoidCommand>();
}
