...
#include "altair_interfaces/msg/detail/servo_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const altair_interfaces::msg::ServoCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  altair_interfaces::msg::ServoCommand & ros_message)
{
  // Member: angles
  {
    cdr >> ros_message.angles;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = altair_interfaces::msg::ServoCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const altair_interfaces::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<altair_interfaces::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  return &altair_interfaces::msg::typesupport_fastrtps_cpp::_ServoCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, altair_interfaces, msg, ServoCommand)() {
  return &altair_interfaces::msg::typesupport_fastrtps_cpp::_ServoCommand__handle;
}
