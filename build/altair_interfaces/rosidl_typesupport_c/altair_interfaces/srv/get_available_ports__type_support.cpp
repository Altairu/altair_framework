...
static const _GetAvailablePorts_Request_type_support_symbol_names_t _GetAvailablePorts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, GetAvailablePorts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, GetAvailablePorts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, GetAvailablePorts_Request)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::GetAvailablePorts_Request_message_type_support_handle;
}
...
static const _GetAvailablePorts_Response_type_support_symbol_names_t _GetAvailablePorts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, GetAvailablePorts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, GetAvailablePorts_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, GetAvailablePorts_Response)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::GetAvailablePorts_Response_message_type_support_handle;
}
...
static const _GetAvailablePorts_type_support_symbol_names_t _GetAvailablePorts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, GetAvailablePorts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, GetAvailablePorts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, GetAvailablePorts)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::GetAvailablePorts_service_type_support_handle;
}
