...
static const _StartBehavior_Request_type_support_symbol_names_t _StartBehavior_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, StartBehavior_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, StartBehavior_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, StartBehavior_Request)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::StartBehavior_Request_message_type_support_handle;
}
...
static const _StartBehavior_Response_type_support_symbol_names_t _StartBehavior_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, StartBehavior_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, StartBehavior_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, StartBehavior_Response)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::StartBehavior_Response_message_type_support_handle;
}
...
static const _StartBehavior_type_support_symbol_names_t _StartBehavior_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, StartBehavior)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, StartBehavior)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, StartBehavior)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::StartBehavior_service_type_support_handle;
}
