...
static const _TriggerControl_Request_type_support_symbol_names_t _TriggerControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, TriggerControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, TriggerControl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, TriggerControl_Request)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::TriggerControl_Request_message_type_support_handle;
}
...
static const _TriggerControl_Response_type_support_symbol_names_t _TriggerControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, TriggerControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, TriggerControl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, TriggerControl_Response)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::TriggerControl_Response_message_type_support_handle;
}
...
static const _TriggerControl_type_support_symbol_names_t _TriggerControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, altair_interfaces, srv, TriggerControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, altair_interfaces, srv, TriggerControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, altair_interfaces, srv, TriggerControl)() {
  return &::altair_interfaces::srv::rosidl_typesupport_c::TriggerControl_service_type_support_handle;
}
